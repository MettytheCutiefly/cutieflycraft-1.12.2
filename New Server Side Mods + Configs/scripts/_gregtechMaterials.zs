...
naquadriaticFuel.setFluidTemperature(3000);
	...
	#Molten Vinteum
val moltenVinteum = MaterialRegistry.createFluidMaterial(829, "moltenvinteum", 0x5dbcd2, "FLUID");
moltenVinteum.addFlags(["GENERATE_FLUID_BLOCK"]);
moltenVinteum.setFluidTemperature(3000);
