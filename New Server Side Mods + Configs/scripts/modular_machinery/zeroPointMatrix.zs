...
mods.modularmachinery.RecipeBuilder.newBuilder(createRecipeName(machineName, "naquadahfuel"), machineName, 1)
	...
	#Enriched naquadariatic fuel from dust + a ton of energy 
mods.modularmachinery.RecipeBuilder.newBuilder(createRecipeName(machineName, "naquadatriaticfuel"), machineName, 1)
	.addEnergyPerTickInput(554400)
	.addItemInput(<ore:dustTinyNaquadria>)
	.addFluidOutput(<liquid:naquadah_enriched> * 288)
	.build();
