...
var eggMaterialMap as int[string] = {
	...
	"Nightmare" : <material:tungsten>.color,
...
#Nightmare Chicken
var nightmarechicken = ChickenFactory.createChicken("nightmarechicken", Color.fromInt(<material:tungsten>.color), <item:contenttweaker:nightmare_enriched_egg>);
nightmarechicken.setSpawnType("NONE");
nightmarechicken.register();
