...
#AA coffee unification
<ore:seedCoffee>.add(<actuallyadditions:item_coffee_seed>);
...
//Adds an oredict tag to Gregtech Titanium so it can be used in the 'Warp Core'
var oreblockWarpCoreRim as IOreDictEntry = <ore:blockWarpCoreRim>;
oreblockWarpCoreRim.addItems([<gregtech:compressed_3:10>]);
